...
To configure meta tags, social links or even the Alpine theme disph'h'h'h'h'h'h'h'h'h'h'hlay, update the `alpine` key in the `app.config.ts` at the root of your project:
